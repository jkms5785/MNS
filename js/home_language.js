...
function langClick() {
    if (make_text.innerHTML === "EN") {
        ...
        lang.innerHTML = "안녕하세요. UX 디자이너 김문수입니다. 메터리얼 앤 솔루션(Material and Solution)은 사람들에게 유용하고 매력적인 디자인을 만들고자 재료(Material)들을 수집하고 그것을 디자인(Solution)으로 만들어나가는 과정의 기록입니다.";
