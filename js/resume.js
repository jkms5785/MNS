...
function linkTo(a) {
    if (a === "KR") {
        window.open("https://drive.google.com/open?id=1uXu6y0lhmkGqA1SN4RiLi344_PF0HK2r");
    } else {
        window.open("https://drive.google.com/open?id=1OPCndTqaqWjtfNqSenTVsGS_1RVH2b4X");
    }
}
...
function makeResumeModal() {
    ...
    makeModal.style.webkitTransition = "all 100ms ease-in-out";
    makeModal.style.mozTransition = "all 100ms ease-out";
    makeModal.style.oTransition = "all 100ms ease-out";
    makeModal.style.transition = "all 100ms ease-out";
