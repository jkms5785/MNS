...
function imgLoader(i) {
    if (i < imgNum) {
        ...
        imgArry[i - 1].src = `img/kakao_source/img/${i < 10 ? `0${i}` : i}-1.png`;
...
function lazyLoader(i) {
    if (i < imgNum) {
        ...
        Lazy_imgArry[i - 1].src = `img/kakao_source/lazyload/${i < 10 ? `0${i}` : i}.png`;
...
function preloaderIn() {
    ...
    img_thumbnail.src = "img/kakao_source/kakao_thumbnail.png";
