...
var ov_tg = document.getElementById('m-1'),
    ov_tg_Top = ov_tg.offsetTop;

var rs_tg = document.getElementById('m-2'),
    rs_tg_Top = rs_tg.offsetTop;

var dp_tg = document.getElementById('m-3'),
    dp_tg_Top = dp_tg.offsetTop;

var ut_tg = document.getElementById('m-4'),
    ut_tg_Top = ut_tg.offsetTop;

var di_tg = document.getElementById('m-5'),
    di_tg_Top = di_tg.offsetTop;

var pd_tg = document.getElementById('m-6'),
...
function ut_scroll() {
    window.scrollTo(0, ut_tg_Top + 120);
}

function di_scroll() {
    window.scrollTo(0, di_tg_Top - 120);
}

function pd_scroll() {
    window.scrollTo(0, pd_tg_Top);
}

function fd_scroll() {
    window.scrollTo(0, fd_tg_Top - 48);
}
