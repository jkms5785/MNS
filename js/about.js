...
function dateBr() {
    ...
    if (window.innerWidth < 800) {
        ...
        dateCont[1].innerHTML = `Service & Biz developer&nbsp;&nbsp;
                                    <div class="date">Jul 2020 - Aug 2020</div>`;
        dateCont[2].innerHTML = `Designer & Front-end developer&nbsp;&nbsp;
                                    <div class="date">Mar 2019 - Dec 2019</div>`;
        dateCont[3].innerHTML = `Students Reasercher&nbsp;&nbsp;
                                    <div class="date">Mar 2017 - Jul 2019</div>`;
        dateCont[4].innerHTML = `Students Designer&nbsp;&nbsp; <div class="date">Mar 017 - Dec 2019</div>`;
        dateCont[5].innerHTML = `Designer&nbsp;&nbsp;<div class="date">Jan 2014 - Mar 2014</div>`;
    } else {
        ...
        dateCont[4].innerHTML = `Students Designer&nbsp;&nbsp; <span class="date">Mar 2017 - Dec 2019</span>`;
        dateCont[5].innerHTML = `Designer&nbsp;&nbsp;<span class="date">Jan
                                        2014 - Mar 2014</span>`;
    }
}
