...
function ov_scroll() {
    window.scrollTo(0, ov_tg_Top - 40);
}

function rs_scroll() {
    window.scrollTo(0, rs_tg_Top + 464);
}

function dp_scroll() {
    window.scrollTo(0, dp_tg_Top - 112);
}

function ut_scroll() {
    window.scrollTo(0, ut_tg_Top - 40);
}
...
function de_scroll() {
    window.scrollTo(0, de_tg_Top - 80);
}
