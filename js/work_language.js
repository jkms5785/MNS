...
function langClick() {
    if (make_text.innerHTML === "EN") {
        ...
        lang[0].innerHTML = "메터리얼 앤 솔루션. 디자인은 누군가에게 필요한 것을 만들기 위해 재료들을 수집하고, 가공하는 과정이라고 생각합니다. 디자이너는 사람들에게 유용하고, 매력적인 것을 만들어내기 위해 다듬어지지 않은 수많은 재료들을 수집하고, 가공합니다. 이 과정 속에서 디자이너는 치열하게 고민하고, 때로는 마음에 들지 않아 재료를 부수기도 합니다. 마침내 거칠었던 재료들은 디자이너의 손을 거쳐 사람들에게 필요한 아름다운 존재가됩니다. ";
