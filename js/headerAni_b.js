...
function PageDetect() {
    ...
    pageOther[0].style.opacity = "0.8";
    pageOther[1].style.opacity = "0.8";
    pageOther[2].style.opacity = "0.8";
    pageOther[0].style.color = "white";
    pageOther[1].style.color = "white";
    pageOther[2].style.color = "white";
}
